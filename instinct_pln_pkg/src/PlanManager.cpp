...
unsigned char PlanManager::addActionPatternElement(const instinctID bRuntime_ElementID, const instinctID bRuntime_ParentID, const instinctID bRuntime_ChildID, const instinctID bOrder)
{
	Instinct::PlanNode planNode;
